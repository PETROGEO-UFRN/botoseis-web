...
class PlotManager:
    ...
    def __init__(
        ...
        self.renderers["image"] = offsetsImageRendererFactory(
            plot=self.plot,
            source=self.sources["image"],

            offsets=x_positions,
            first_time_sample=FIRST_TIME_SAMPLE,
            widthTimeSamples=width_time_samples,
            isVisible=self.is_visible["image"],
        )
        ...
        self.renderers["wiggle"] = wiggleRendererFactory(
            plot=self.plot,
            source=self.sources["wiggle"],
            isVisible=self.is_visible["wiggle"],
        )
