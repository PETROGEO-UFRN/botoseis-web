...
from ..config.coreApiUrl import coreApiURL
...
class RestAPIConsumer():
    ...
    def find_su_file_path(
        ...
        request_url = f"{coreApiURL}/su-file-path/{self.workflowId}/show-path/output"
        if origin == "input":
    ...
    def load_picks(
        ...
        request_url = f"{coreApiURL}/helper-file/path/{self.workflowId}/table"
    ...
    def save_picks(
        ...
        request_url = f"{coreApiURL}/helper-file/generate/{self.workflowId}/table"
